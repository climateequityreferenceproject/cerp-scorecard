...
// if a user uses the _dev version of the scorecard, we drop a cookie on her 
// computer to identify them as developer, in which case the google analytics
// tracking code gets omitted (even during his use of the public scorecard)
...
if (!($_COOKIE['this_user_is_developer']=='true')) {
    ...
    $ga_script .= "\n";
    $ga_script .= "ga('create', 'UA-62836318-3', 'auto');";
    $ga_script .= "\n";
