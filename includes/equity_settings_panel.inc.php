            ...
            <fieldset id="pathway">
                ...
                <div class="input_set group">
                    ...
                    <ul>
                        ...
                        <li>
                            <label for="ambition-low"><input type="radio" name="ambition" id="ambition-low" class="click" value=<?php echo '"' . $emerg_path_id["G8"] . '" ' . $ambition_checked["G8"]; ?> />G8 marker (An even weaker 2&#176;C pathway, as per the 2009 G8 declaration in L’Aquila)</label>
                        </li>
                    </ul>
                </div>
            </fieldset>
